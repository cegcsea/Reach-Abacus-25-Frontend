      ...
      <div className="flex flex-col lg:flex-row mt-8 gap-8">
        ...
        <div className="w-full lg:w-[55%] mx-auto lg:mx-0">
          ...
          <div className="flex justify-center lg:justify-start gap-4 my-4">
            <button
              className={`border px-4 py-2 text-white duration-150 ${activeTab === "description"
                ? "bg-[#660000]"
                : "border-[#8B0000] hover:bg-[#66000033]"
                } mx-3 text-sm sm:text-base lg:text-lg`}
              onClick={() => setActiveTab("description")}
            >
              Description
            </button>
            <button
              className={`border px-4 py-2 text-white duration-150 ${activeTab === "speakers"
                ? "bg-[#660000]"
                : "border-[#8B0000] hover:bg-[#66000033]"
                } mx-3 text-sm sm:text-base lg:text-lg`}
            ...
            <button
              className={`border px-4 py-2 text-white duration-150 ${activeTab === "more-info"
                ? "bg-[#660000]"
                : "border-[#8B0000] hover:bg-[#66000033]"
                } mx-3 text-sm sm:text-base lg:text-lg`}
